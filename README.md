...
Seema | Khmer, Lao, Myanmar, and Thai word segmentation/breaking library in Python written in Rust | Python/Rust | Maximal matching with cluster rules and split rules | Apache 2.0 | Vee Satayamas, [PyPI](https://pypi.org/project/seema/)
